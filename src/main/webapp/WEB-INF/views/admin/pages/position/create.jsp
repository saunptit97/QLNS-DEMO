  ...
  <div class="content-wrapper">
                            ...
                            <div class="box-header with-border">
                              <h3 class="box-title">Create new Position</h3>
                                ...
                                <div class="form-group name-position" style="margin-bottom: 20px; height: 70px">
                                  	...
                                  	<input type="text" class="form-control" id="name" name="name" placeholder="Enter your position">
                    ...
                    <div class="col-md-4">
                        <div class="box">
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-primary" id="handlePosition">Submit</button>
   ...
   <script>
	   $('#handlePosition').on('click', function(e) {
		    ...
		    $.ajax({
				type : "POST",
				url : "/spring-mvc-qlns/admin/position/store",
				data: {
					name: name,
